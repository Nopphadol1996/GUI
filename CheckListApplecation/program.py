...
root.iconbitmap(r'C://Users//MSI/Desktop//BASICGUITKINTER//Project//CheckListApplecation//icon//check.ico')
...
btnQuit = Button(button_frame, text='ปิดรายการ', font=font, command=root.destroy)
